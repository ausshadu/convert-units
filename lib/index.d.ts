declare module "convert-units" {
    ...
    type uMass = "mcg" | "mg" | "g" | "kg" | "oz" | "lb" | "mt" | "t" | "grain" | "usgal"; // Mass
    type uVolume = "mm3" | "cm3" | "ml" | "cl" | "dl" | "l" | "kl" | "m3" | "km3" | "krm" | "tsk" | "msk" | "kkp" | "glas" | "kanna" | "tsp" | "Tbs" | "in3" | "fl-oz" | "cup" | "pnt" | "qt" | "gal" | "ft3" | "yd3"; // Volume
    type uVolumeFlowRate = "mm3/s" | "cm3/s" | "ml/s" | "cl/s" | "dl/s" | "l/s" | "l/min" | "l/h" | "kl/s" | "kl/min" | "kl/h" | "m3/s" | "m3/min" | "m3/h" | "km3/s" | "tsp/s" | "Tbs/s" | "in3/s" | "in3/min" | "in3/h" | "fl-oz/s" | "fl-oz/min" | "fl-oz/h" | "cup/s" | "pnt/s" | "pnt/min" | "pnt/h" | "qt/s" | "gal/s" | "gal/min" | "b-gal/min" | "gal/h" | "ft3/s" | "ft3/min" | "ft3/h" | "yd3/s" | "yd3/min" | "yd3/h"; // Volume Flow Rate
    ...
    type uSpeed = "m/s" | "km/h" | "m/h" | "knot" | "ft/s" | "ft/min" | "m/min"; // Speed
    type uPace = "s/m" | "min/km" | "s/ft" | "min/km"; // Pace
    type uPressure = "Pa" | "hPa" | "kPa" | "MPa" | "bar" | "torr" | "psi" | "ksi" | 'kgf/cm2' | 'lb/in2' | 'oz/in2' | 'atm' | 'inHg' | 'ftH20' | 'millitorr'; // Pressure
